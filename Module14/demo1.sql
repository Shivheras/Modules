...
CREATE TABLE dbo.ProductImport ( ProductImportID int IDENTITY(1,1) PRIMARY KEY,ProductDetails xml (CONTENT dbo.ProductDetailsSchema));

INSERT INTO dbo.ProductImport (ProductDetails) VALUES ('<invalid xml');

INSERT INTO dbo.ProductImport (ProductDetails)
...
INSERT INTO dbo.ProductImport (ProductDetails) VALUES ('
