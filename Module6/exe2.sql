...
ALTER TABLE Sales.SalesOrderDetailClustered ADD CONSTRAINT PK_SalesOrderDetailClustered
...
SELECT * FROM Sales.SalesOrderDetailClustered;

SELECT * FROM Sales.SalesOrderDetailHeap ORDER BY SalesOrderID, SalesOrderDetailID OPTION (MAXDOP 1);

SELECT * FROM Sales.SalesOrderDetailClustered ORDER BY SalesOrderID, SalesOrderDetailID;

SELECT * FROM Sales.SalesOrderDetailHeap WHERE SalesOrderID BETWEEN 50000 AND 53000;

SELECT * FROM Sales.SalesOrderDetailClustered WHERE SalesOrderID BETWEEN 50000 AND 53000;

SELECT * FROM Sales.SalesOrderDetailHeap WHERE SalesOrderID BETWEEN 50000 AND 53000 ORDER BY SalesOrderID, SalesOrderDetailID;
